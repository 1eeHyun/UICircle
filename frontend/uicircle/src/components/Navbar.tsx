            ...
            <div className="flex items-center gap-3">
              ...
              {isLoggedIn && (
                <button
                  ...
                  className="hidden sm:inline-flex items-center px-3 py-1.5 rounded-lg bg-primary text-white text-sm font-medium hover:bg-primary/90 transition-colors"
                >
                  List and Item
                </button>
              )}
